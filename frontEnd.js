...
// Flag Variables used in this file 
...
var clockDIV	 = document.getElementById("clock"); // Wrapper element for clockDisplay 
var hourDIV	 	 = document.getElementById("clock-hour"); // HTML Element where the clock is actually displayed 
var stopWatchDIV = document.getElementById("stopWatch"); // HTML Element for where the stopwatch time is displayed 
var timerDIV	 = document.getElementById("timer"); // HTML Element for where the timer is displayed 
var calendarDIV   	 = document.getElementById("calendar"); // HTML Element where the date is displayed 



var clockModeMenu 	 = document.getElementById("amORpm"); // Dropdown select item for am_pm
var stopWatchRunButton  = document.getElementById("stopWatchBtn"); // Button to start pause stopwatch 
var clockMilitaryButton = document.getElementById("clockMilBtn"); // Button to swtich from civilian to military time and vice versa 
var stopTimerButton   	= document.getElementById("pauseTimerBtn"); // Button to pause/ restart Timer 
